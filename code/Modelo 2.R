##### Mi modelo de ecuaciones estructurales (2) ########
library(readxl)
library(plspm)
Base <- read_excel("ESPECIALIDAD EME/2 SEMESTRE/Proyecto/Base2.xlsx")
View(Base)
dim(Base)
#Arrancamos!
#modelo interno
...
Base_blocks = list(12:16, 17:20, 21:25, 26:29, 30:34, 35:39,40:43,44:48)
...
#salió bn pero no me convwncen una 
...
expect_val = plspm(Base, edu_path, expect_pls1, modes = Base_modes,
